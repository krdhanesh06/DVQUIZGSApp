...
public class L2R extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l2_r);
        ...
        sb.append("" + L2Q.correct + "\n");
        StringBuffer sb2 = new StringBuffer();
        sb2.append("" + L2Q.wrong + "\n");
        StringBuffer sb3 = new StringBuffer();
        sb3.append("" + L2Q.correct + "\n");
        ...
        if(L2Q.correct>=6){
            Toast.makeText(this,"Excellent! \n You Cleared Level Second.", Toast.LENGTH_LONG).show();
            btnFeedback.setVisibility(View.VISIBLE);

        }
        else {
            Toast.makeText(this, "Oops! \n You Couldn't Clear Level Second.", Toast.LENGTH_LONG).show();
    ...
    public void btnRetest(View view) {
        ...
        Intent in = new Intent(getApplicationContext(),L2V.class);
    ...
    public void Feedback(View view) {
        ...
        String marks2 = tv3.getText().toString();

        Intent in = new Intent(getApplicationContext(),Feedback2.class);
        in.putExtra("name", name);
        in.putExtra("mobile", mobile);

        in.putExtra("marks2", marks2);
