...
public class Feedback4 extends AppCompatActivity {
    TextView dispName, dispMobile,dispMarks4;
    EditText message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispMarks4= (TextView) findViewById(R.id.dispMarks4);
        ...
        String marks4 = intent.getStringExtra("marks4");
        dispMarks4.setText(marks4);
        dispMarks4.setTextColor(Color.BLUE);
        dispMarks4.setText("Fourth Level Marks= "+marks4);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (myTTS.getEngines().size() == 0) {
                    Toast.makeText(Feedback4.this, "There is no TTS engine on your device", Toast.LENGTH_LONG).show();
                    finish();
                } else {
    ...
    public void Logout(View view) {
        speak(" ");
        Intent dkp = new Intent(Feedback4.this, Thanks.class);
        startActivity(dkp);
        Toast.makeText(Feedback4.this,"Log Out Successfully \n Thank you!", Toast.LENGTH_LONG).show();
        finish();
    }
    ...
    private void addUsersToSheet() {
        ...
        final String tmarks = dispMarks4.getText().toString().trim();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbx8Wq96CR5lVeaEATevaJIWoJIxFYyh9uK8r2nDODWiC8eCS-UI/exec",new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                loading.dismiss();
                Toast.makeText(Feedback4.this,response,Toast.LENGTH_LONG).show();
            }
        },
