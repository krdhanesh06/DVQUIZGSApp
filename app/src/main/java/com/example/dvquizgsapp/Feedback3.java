...
public class Feedback3 extends AppCompatActivity {
    ...
    TextView dispName, dispMobile,dispMarks3;
    EditText message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispMarks3= (TextView) findViewById(R.id.dispMarks3);
        ...
        String marks3 = intent.getStringExtra("marks3");
        dispMarks3.setText(marks3);
        dispMarks3.setTextColor(Color.BLUE);
        dispMarks3.setText("Third Level Marks= "+marks3);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (myTTS.getEngines().size() == 0) {
                    Toast.makeText(Feedback3.this, "There is no TTS engine on your device", Toast.LENGTH_LONG).show();
                    finish();
                } else {
    ...
    public void Logout(View view) {
        speak(" ");
        Intent dkp = new Intent(Feedback3.this, Thanks.class);
        startActivity(dkp);
        Toast.makeText(Feedback3.this,"Log Out Successfully \n Thank you!", Toast.LENGTH_LONG).show();
        finish();
    }
    ...
    public void sendsms(View view) {
        ...
        Intent intent=new Intent(getApplicationContext(), L4V.class);
    ...
    private void addUsersToSheet() {
        ...
        final String tmarks = dispMarks3.getText().toString().trim();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbx8Wq96CR5lVeaEATevaJIWoJIxFYyh9uK8r2nDODWiC8eCS-UI/exec",new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                loading.dismiss();
                Toast.makeText(Feedback3.this,response,Toast.LENGTH_LONG).show();
            }
        },
