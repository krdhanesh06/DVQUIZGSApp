...
public class Feedback extends AppCompatActivity {
    TextView dispName, dispMobile,dispMarks1;
    EditText message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dispMarks1= (TextView) findViewById(R.id.dispMarks1);
        ...
        String marks1 = intent.getStringExtra("marks1");
        dispMarks1.setText(marks1);
        dispMarks1.setTextColor(Color.BLUE);
        dispMarks1.setText("First Level Marks= "+marks1);
        ...
        myTTS = new TextToSpeech(this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (myTTS.getEngines().size() == 0) {
                    Toast.makeText(Feedback.this, "There is no TTS engine on your device", Toast.LENGTH_LONG).show();
                    finish();
                } else {
   ...
   public void Logout(View view) {
        speak(" ");
        Intent dkp = new Intent(Feedback.this, Thanks.class);
        startActivity(dkp);
        Toast.makeText(Feedback.this,"Log Out Successfully \n Thank you!", Toast.LENGTH_LONG).show();
        finish();
    }
    ...
    public void sendsms(View view) {
        ...
        Intent intent=new Intent(getApplicationContext(), L2V.class);
...
private void addUsersToSheet() {
            ...
            final String tmarks = dispMarks1.getText().toString().trim();
