...
public class L3R extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_l3_r);
        ...
        sb.append("" + L3Q.correct + "\n");
        StringBuffer sb2 = new StringBuffer();
        sb2.append("" + L3Q.wrong + "\n");
        StringBuffer sb3 = new StringBuffer();
        sb3.append("" + L3Q.correct + "\n");
        ...
        if(L3Q.correct>=6){
            Toast.makeText(this,"Excellent! \n You Cleared Level Third.", Toast.LENGTH_LONG).show();
            btnFeedback.setVisibility(View.VISIBLE);

        }
        else {
            Toast.makeText(this, "Oops! \n You Couldn't Clear Level Third.", Toast.LENGTH_LONG).show();
    ...
    public void btnRetest(View view) {
        ...
        Intent in = new Intent(getApplicationContext(),L3V.class);
    ...
    public void Feedback(View view) {
        String name = dispName.getText().toString();
        String mobile = dispMobile.getText().toString();
        String marks3 = tv3.getText().toString();
        Intent in = new Intent(getApplicationContext(),Feedback3.class);
        in.putExtra("name", name);
        in.putExtra("mobile", mobile);
        in.putExtra("marks3", marks3);
        startActivity(in);
    }
}